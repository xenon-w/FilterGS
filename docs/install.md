...
Follow these instructions to set up the FilterGS environment on your machine, similar to LoG.
...
```bash
conda create --name FilterGS python=3.10 -y
conda activate FilterGS
```
...
```bash
git clone https://github.com/xenon-w/FilterGS.git
cd FilterGS
